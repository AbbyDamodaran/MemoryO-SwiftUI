...
//  MemoryO
//
//  Created by Abby Damodaran on 3/22/24.
//
            ...
            if let firstIndex = selectedCardIndex {
                if index != firstIndex {
                    ...
                    if cards[index].id == cards[firstIndex].id {
                        ...
                        matchedPairs += 1
                        matchedCardPositions = [CGPoint(x: index % gridSize, y: index / gridSize),
                                                CGPoint(x: firstIndex % gridSize, y: firstIndex / gridSize)]
                        isMatchedAnimationActive = true
                    } else {
